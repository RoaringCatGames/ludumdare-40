...
namespace LitterBox.ScreenCapture
{
  ...
  public class ScreenCaptureComponent : MonoBehaviour
  {
    ...
    [Tooltip("You must mark this true to save a version to the local file system")]
    public bool shouldSaveToFile = false;
    ...
    {
      StartCoroutine(ScreenCaptureUtil.CaptureScreenShotAsTexture(HandleScreenCaputure, hideUIOnScreenCapture, shouldSaveToFile, relativeFileSavePath, savedFileNameFormatted));
    }
